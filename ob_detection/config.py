...
class Config:
    def __init__(self):
        ...
        self._templates = {
            'mario_frwrd' :{  'path':'images/templates/mario_forward.png',
                        'color': (3, 255, 32),
                        'threshold': self.threshold,
                        },
            'mario_backwrd' :{  'path':'images/templates/mario_backward.png',
                        'color': (3, 255, 32),
                        'threshold': self.threshold,
                        },
            'enemy1':{  'path':'images/templates/enemy1.png',
                        'color': (0, 0, 255),
                        'threshold': self.threshold,
                        },
            'obs1'  :{  'path':'images/templates/obs1.png',
                        'color': (255, 162, 0),
                        'threshold': self.threshold,
                        },
            'obs3'  :{  'path':'images/templates/obs3.png',
                        'color': (255, 162, 0),
                        'threshold': self.threshold,
                        },
            'obs2'  :{  'path':'images/templates/obs2.png',
                        'color': (255, 162, 0),
                        'threshold': self.threshold,
                        },
            'brick' :{  'path':'images/templates/brick.png',
                        'color': (255, 162, 0),
                        'threshold': self.threshold,
                        },
        }
